Shader "Demos/Phong with Texture"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target {
                ...
                float spec = pow(max(0, dot(i.viewDir, reflectDir)), _SpecularExponent);
                float3 specularColor = _Specular * spec;

                // Final color calculation (Lambertian diffuse + Phong specular)
